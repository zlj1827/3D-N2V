...
## a separate U-Net subnetwork is built for each input channel
def build_single_unet_per_channel(input_shape,
    ...
    ## Independent U-Net branches are constructed for each channel
    out_channels = []
    num_channel_out = 1
    ...
    ## consolidate all channel outputs
...
## All channels are taken as a whole to establish the unet model
