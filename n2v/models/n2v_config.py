...
class N2VConfig(argparse.Namespace):
    ...
    >>> n2v_config = N2VConfig(X, unet_n_depth=2)
    ...
    ## Accepts a list of parameters set in config
    ...
    # Update the properties of the N2V model configuration
