...
class N2V(CARE):
    """The Noise2Void training scheme to train a standard CARE network for image restoration and enhancement.
        ...
        Parameters
        ----------
        config : :class:`n2v.models.N2VConfig` or None N2V
        ...
        Attributes
        ----------
        config : :class:`n2v.models.N2VConfig` N2V
    ...
    ## Build the U-Net network structure and pass in all configuration parameters
    def _build(self):
